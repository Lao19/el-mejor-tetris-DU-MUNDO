...
public class Tablero extends JPanel implements KeyListener {
    ...
    private void crearBotonRegresar() {
        botonRegresar = new JButton("Menu");
    ...
    Color.decode("#7B4B94"),Color.decode("#FF674D"), Color.decode("#EFEBCE")};
    // private int[][] shape1 = {
    //     {1,1,1},
    //     {0,1,0}
    // };
    ...
    //variable pa saber si ya se mostro el cuadro
    ...
    protected void paintComponent(Graphics g) {
        ...
        if(state==STATE_GAME_PAUSE){
            g.setColor(Color.black);
            g.drawString("CONGELAU", 325, 200);
        }

        //se muestra la puntuacion del jugador
        g.setColor(Color.black);
        g.drawString("Puntuación: " + score, 325, 100);
